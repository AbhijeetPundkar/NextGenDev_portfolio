...
export default function Projects() {
  const projects = [
    {
      title: "FinServe",
      tech: [SiNextdotjs, SiTypescript, SiTailwindcss, SiChartdotjs],
      link: "https://github.com/AbhijeetPundkar/bank-app",
      cover: "/bank.png", // Replace with actual path to cover image
